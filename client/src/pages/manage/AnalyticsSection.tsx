...
// All eight categorical slots come from the validated theme ramp in
// index.css - the legend beside the pie carries the values, which is
// what licenses the lower-contrast slots.
const PIE_COLORS = [
  "hsl(var(--chart-1))",
  "hsl(var(--chart-2))",
  "hsl(var(--chart-3))",
