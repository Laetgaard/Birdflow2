      ...
      <div style={{ maxWidth: '620px', margin: '0 auto', textAlign: 'center' }}>
        ...
        {socialProof && !submitted && (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', marginBottom: '20px', fontSize: '13px', opacity: 0.55 }}>
            ...
            {canEdit ? (
              <EditableText value={socialProof} field="socialProof" isEditing={editingField === 'socialProof'} onEdit={onEditField || (() => {})} onChange={onTextChange || (() => {})} style={{ fontSize: '13px' }} as="span" isPreview={isPreview} />
            ) : socialProof}
          </div>
        )}
        {submitted ? (
        ...
        {privacyNote && !submitted && (
          <p style={{ fontSize: '12px', opacity: 0.4, marginTop: '14px', lineHeight: 1.6 }}>
            ...
            {canEdit ? (
              <EditableText value={privacyNote} field="privacyNote" isEditing={editingField === 'privacyNote'} onEdit={onEditField || (() => {})} onChange={onTextChange || (() => {})} style={{ fontSize: '12px' }} as="span" isPreview={isPreview} />
            ) : privacyNote}
          </p>
        )}
      </div>
